...
string/g globalwave = waveName
	...
	Variable wind = .2
	//////////////////////////////////////////////////////
	Variable/G unitaryEvent = 0.2	//Estimate of the amplitude of an individual event (usually 0.2 for bipolar cells)
	/////////////////////////////////////////////////////
	
	Variable scalingfactor=unitaryEvent/tauDecay  //This scaling factor gets the amplitudes right
	
	duplicate/o $waveName, xsignal, h, xfiltered, wave_smth
	Redimension/N=-1 wave_smth
	
	//NB The S wave is now the low-pass filtered version of the raw (50 Hz corner freq)
	Make/O/D/N=0 coefs
	//FilterFIR/DIM=0/LO={50*deltat,60*deltat,101}/COEF coefs, wave_smth
	Smooth/S=2 Nsmoothpoints, wave_smth				//Savitsky-Golay. Old method.

	//STEP 1: Make the impulse response, h 	
	h=unitaryEvent*(1-exp(-x/taurise))*exp(-x/tauDecay)
	//h=unitaryEvent*exp(-x/tauDecay)
	...
	Duplicate/O/C SF SNR, SNR2
	Duplicate/O/C SF N
	N=noiseVariance
	SNR = (unitaryEvent*tauDecay*HMAGSQR)/N   //I don't know quite why I need to scale in this way! SNR is frequency-dependent.  Gaussian power spectrum is flat
	//SNR = sqrt(((unitaryEvent*tauDecay*HMAGSQR)/N)^2)
	//SNR = 0.001
	...
	//killwaves SNR, SF, N, levelsWave, kernel_smth, HMAGSQR, HF, h, G, xCONVG,xfiltered,xSig,xsignal, wave_smth
	killwaves w_coef
end

///////////////////////////////////////////////////////////////////////////////////

Function newnewWiener(waveName)
...
string/g globalwave = waveName
	...
	String smoothwaveName = waveName +"_D"
